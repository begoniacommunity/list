...
+ [DroidCam.](https://play.google.com/store/apps/details?id=com.dev47apps.droidcam&hl=ru&gl=US) Использование камеры и микрофона устройства на ПК. [Клиенты для декстопных платформ.](https://www.dev47apps.com/) 
...
1. Скачиваем последние версии [Google Contacts Sync](https://www.apkmirror.com/apk/google-inc/google-contacts-sync/) и [Google Calendar Sync.](https://www.apkmirror.com/apk/google-inc/google-calendar-sync/) Переименовываем файлы в `GoogleContactsSyncAdapter.apk` и `GoogleCalendarSyncAdapter.apk`.
...
### Моды
* [Vendetta.](https://github.com/vendetta-mod/Vendetta) Работает по аналогии с Vencord, только на телефоне. Удобнее устаналивать через [Vendetta Manager.](https://github.com/vendetta-mod/VendettaManager) Запускается немного дольше немодифицированного клиента.
