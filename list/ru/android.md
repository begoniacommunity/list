...
* <sup>`(Модуль / Android 11+)`</sup> [Модуль, отключающий эффект приближения обоев на рабочем столе при разблокировке устройства и открытии/сворачивании приложения.](https://index.teamfiles.workers.dev/0:/WallZoomAddon/)
...
### 🚕 Такси и навигация
* [AltoCar.](https://altocar.ru/) Агрегатор выгодных предложений такси в России. Чаcто водители доступных сервисов, кроме Яндекса, не откликаются на заявки. Не поддерживается чат с водителем и смена варианта оплаты после заказа, в чем приложение сильно уступает по удобству клиенту ЯндексGo.
...
Советую заглянуть в [Awesome Shizuku.](https://github.com/ThePBone/awesome-shizuku) Это обновляемый список приложений, поддерживающих работу через локальный adb.
