...
* [Windhawk.](https://github.com/ramensoftware/windhawk) Инъекции кода в Windows.
  ...
  * [Если с Windhawk не запускаются приложения пакета MS Office](https://github.com/ramensoftware/windhawk/issues/198#issuecomment-2163986031)
...
### 🤖 Эмуляторы
* (здесь должен быть какой-нибудь ретро-эмулятор, который вы посоветуете)
...
* [WatchTogetherAdblock.](https://vencord.dev/plugins/WatchTogetherAdblock) Блокировка рекламы в YouTube при использовании активности Watch Together. Для блокировки используется AdGuard.
