...
>
> [!WARNING]
> В последнее время HuskyDG, разработчик Kitsune Mask, стал вносить в свой проект серьёзные изменения, ломающие устаревшие программы и модули. Держите это в виду во время следования инструкциям. Из известных несовместимостей: AdAway, Termux. 
